# HarryRestaurant Website

**HarryRestaurant** is a Ruby on Rails restaurant website let users order foods.

Submitted by: **Nguyễn Ngọc Danh**

Time spent: **12** hours spent in total

URL: **https://harry-restaurant.herokuapp.com/**
...
- Partial view is not optimized.
- Still have "Fat controller".

* List bugs or things that don't work yet

- Sorting dropdown list sometime not in its right position.
